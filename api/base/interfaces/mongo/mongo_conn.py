...
class MongoSettings:
    ...
    uri: str = (
        ...
        if username
        else "mongodb://{}:{}".format(host, port)
    )
    database: str = "template_api"
    template_collection: str = "template"
...
class Database(MongoClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.template_collection = self[MongoSettings.database][
            MongoSettings.template_collection
        ]
